...
export LoadConfig_microprogram405
export _LoadConfig_microprogram405
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_microprogram405
	lcall	LoadConfigTBL_microprogram405_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration microprogram405
;
;    Load configuration registers for microprogram405.
...
;               CUR_PP
;
_LoadConfig_microprogram405:
 LoadConfig_microprogram405:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_microprogram405_Bank0
    mov     X, <LoadConfigTBL_microprogram405_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_microprogram405_Bank1
    mov     X, <LoadConfigTBL_microprogram405_Bank1
